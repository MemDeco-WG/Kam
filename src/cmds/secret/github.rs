...
/// AUTO-GENERATED BY Kam/scripts/add_missing_docs.py: placeholder documentation for public function 'fetch_cert_from_issue'. Replace with real documentation. (2025-12-30T22:23:21Z)
/// # Errors
/// Returns `KamError` on network or JSON parsing failures.
pub fn fetch_cert_from_issue(user: &str, repo: &str, issue_num: u32) -> Result<String, KamError> {
    let client = Client::new();

    // 先抓issue看看
    let issue_url = format!("https://api.github.com/repos/{user}/{repo}/issues/{issue_num}");
...
// 能处理多个证书（链式的那种）
/// AUTO-GENERATED BY Kam/scripts/add_missing_docs.py: placeholder documentation for public function 'extract_cert_chain'. Replace with real documentation. (2025-12-30T22:23:21Z)
#[must_use]
