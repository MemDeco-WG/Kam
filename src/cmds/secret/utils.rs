...
fn read_cached_passphrase(name: &str) -> Result<Option<String>, KamError> {
    ...
    let cache: PassphraseCache = match serde_json::from_str(&s) {
        Ok(c) => c,
        Err(_) => {
