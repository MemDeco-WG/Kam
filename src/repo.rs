...
pub fn find_module(modules: &Vec<Module>, id: String) -> Module {
    ...
    modules[module_pos].clone()
}

pub fn find_version(versions: Vec<Version>, version_name: String) -> Version {
